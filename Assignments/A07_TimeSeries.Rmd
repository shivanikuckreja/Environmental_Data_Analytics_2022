...
as.data.frame(Mean_Monthly_Ozone$time.series[,1:3])

GaringerOzone_Monthly_NonSeasonal <-
  mutate(GaringerOzone_Monthly_NonSeasonal, 
         Observed = GaringerOzone.monthly$mean_Ozone,
           Date = GaringerOzone.monthly$Date)

#16
GaringerOzone_Monthly_Trend3 <- Kendall::MannKendall(GaringerOzone.monthly.ts)
