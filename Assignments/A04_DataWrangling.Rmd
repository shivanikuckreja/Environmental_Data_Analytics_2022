...
dim(EPArbind_filter)
# only has 7899 observations of 9 variables 

#9
EPArbind_spread <- separate(EPArbind, AQS_PARAMETER_DESC, c("Ozone", "PM2.5"))
...
#11
write.csv(EPA.PM25.2019_Select, file = "../Data/Processed/EPAair_O3_PM25_NC2122_Processed.csv")
```
