...
dataframe <- data.frame("WaterSystemName" = as.character(name_web), 
"PWSID" =  as.character(pwsid_web),                 
"Ownership" =  as.character(ownership_web),
"MaxWithdrawals" =  as.character(maxwithdrawals_web),
...
ggplot(withdrawals.2015, aes(x=Date,y=max.withdrawals.mgd)) + 
  geom_point() + 
  labs(title = paste("Max Daily Withdrawals Across the Months"),
       subtitle = 2020,
      # scale_x_date(date_breaks="Month"), # code to show all month labels 
