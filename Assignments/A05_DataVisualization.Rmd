...
#PeterPaul_chem_nutrients_theme <- ggplot(PeterPaul_chem_nutrients) +
  #geom_point(aes(x = Date, y = Ozone)) +
  #theme_gray()
#print(PeterPaul_chem_nutrients_theme)


#NW_litter_theme <- ggplot(NW_litter) +
  #geom_point(aes(x = Date, y = Ozone)) +
 # theme_gray()
#print(NW_litter_theme)
...
```{r}
#4
NTLLTER_Plot <- ggplot(filter(PeterPaul.chem.nutrients)) +
  geom_point(aes(x = tp_ug, y = po4, color=year4)) +
  facet_wrap('lakename') +
  ylab('Po4')
  xlim(-7, 1000) +
  ylim(0, 20)+
print(NTLLTER_Plot)
  ...
  # geom_line(color = "black") # how do I add a best fit line? 
```
