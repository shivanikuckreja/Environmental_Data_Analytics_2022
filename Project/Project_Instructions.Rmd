...
#types of analyses: timeseries, GLM, spatial visualization
...
#hide output or hide message so certain code doesn't show
...
#Have a caption for each table/plot
...
#do not upload data set and RMD file. Just need to upload PDF
...
#initial plots we make. First analyses we do when we are trying to identify which variables will be good regressors for the data
