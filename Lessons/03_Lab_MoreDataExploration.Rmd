...
```{r}
vector1 <- c(58,41,42,45,35,42,48,51,55,66) # numeric vector in fahrenheit highs

vector2 <- c(30,24,19,25,21,18,22,24,29,43) # numeric vector in fahrenheit lows
```
...
```{r}
vector3 <- c(14,5,6,7,2,6,9,11,13,19) # numeric vector in celcius highs

vector4 <- c(-1,-4,-7,-4,-6,-8,-6,-4,-2,6) # numeric vector in celcius lows
...
```{r}
dataframe_temperatures <- data.frame(vector1, vector2, vector3, vector4)
dataframe1 <- data.frame(dataframe_temperatures)
```
