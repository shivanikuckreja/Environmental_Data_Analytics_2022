...
#mean is 40.88. But what if we did another sample? Is that also below 50? This is what T-test tests for 

# Evaluate assumption of normal distribution
shapiro.test((EPAair.subsample$Ozone)) #data is not normal 
