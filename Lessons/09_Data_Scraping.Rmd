...
the_registrant <- webpage %>% 
  html_nodes(".table tr:nth-child(1) td:nth-child(2)") %>% #grabs value associated with these tags
  #first pull whole webpage into coding environment using read.html
  #then identify tags (html nodes) 
  #then html text 
  html_text()
the_registrant
```
