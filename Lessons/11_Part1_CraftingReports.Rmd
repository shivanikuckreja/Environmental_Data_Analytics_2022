...
author: Environmental Data Analytics | John Fay & Luana Lima | Developed by 
Kateri Salk. Completed by Shivani Kuckreja
date: "Spring 2022"
output:
...
```{r, include = FALSE}
Nutrients.Raw <-
  read.csv("../Data/Raw/NTL-LTER_Lake_Nutrients_Raw.csv", 
...
Nutrients.Raw$sampledate <- 
  as.Date(Nutrients.Raw$sampledate, format = "%Y-%m-%d")
...
select(tp_ug, year4) %>%
filter(!is.na(tp_ug) & !is.na(year4))
